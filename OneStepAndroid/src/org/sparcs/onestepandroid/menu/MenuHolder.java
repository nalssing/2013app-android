...
public class MenuHolder {
	...
	public MenuHolder() {
		...
		menus.add(menu);
		menu = new MyMenu(MyMenu.Type.SECTION_HEADER, "학우제안정책","suggetion", R.drawable.student_suggestion);
		menus.add(menu);
		menu = new MyMenu(MyMenu.Type.SINGLE_LINE, "BEST", "suggetion");
		menus.add(menu);
		menu = new MyMenu(MyMenu.Type.SINGLE_LINE, "검토중", "suggetion");
		menus.add(menu);
		menu = new MyMenu(MyMenu.Type.SINGLE_LINE, "진행중","suggetion");
		menus.add(menu);
		menu = new MyMenu(MyMenu.Type.SINGLE_LINE, "전체 제안 보기", "suggetion");
		menus.add(menu);
